...
And at a pinch you can log 23 bits of variable data, but you need to set the target address up in RAM first and then do an indirect `sta`, so it's more hard work.
